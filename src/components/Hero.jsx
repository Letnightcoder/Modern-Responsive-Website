  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        viewport={{ once: true }}
        className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5pxl"
      >
      ...
      <motion.p
        ...
        viewport={{ once: true }}
        className="text-sm sm:text-lg font-meium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3"
      >
